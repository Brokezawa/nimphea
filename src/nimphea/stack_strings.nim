# =============================================================================
# Vendored third-party module — intentionally NOT prefixed with `nimphea_`.
#
# Source   : https://github.com/termermc/nim-stack-strings
# Version  : 1.1.4 (tag v1.1.4, commit acb6bd76f9b5b7a88b76a01767844760231fc17f)
# Author   : termermc
# License  : MIT — see stack_strings/LICENSE in this package
# Imported : 2026-08-24
#
# Everything below this header is kept pristine (unmodified upstream) so that
# future upstream merges stay diffable. Do not edit this file directly. To sync
# with upstream, replace it with a fresh copy and re-run the host tests.
# =============================================================================
##[
