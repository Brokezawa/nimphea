...
# Transport Configuration and NeoPixel types are defined in nimphea_core_types
...
proc getPixelColor*(this: NeoPixelI2C, n: uint16): uint32 {.importcpp: "#.GetPixelColor(@)".}
...
proc numPixels*(this: NeoPixelI2C): uint16 {.importcpp: "#.NumPixels()".}
