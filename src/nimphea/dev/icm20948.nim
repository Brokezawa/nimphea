...
## type differs (`Icm20948I2C` vs `Icm20948Spi`).
##
## **Features:**
...
# The C++ driver is a template (daisy::Icm20948<T>); both instantiations expose
# the same method names, so a single generic binding covers both.

proc init*[T: Icm20948I2C | Icm20948Spi, C](sensor: var T, config: C): Icm20948Result
...
proc reset*[T: Icm20948I2C | Icm20948Spi](sensor: var T)
  {.importcpp: "#.Reset()", header: "dev/icm20948.h".}
  ## Reset the sensor to default settings
proc setupMag*[T: Icm20948I2C | Icm20948Spi](sensor: var T): Icm20948Result
  {.importcpp: "#.SetupMag()", header: "dev/icm20948.h".}
  ## Setup the magnetometer. Must be called after `init` to enable readings.
proc process*[T: Icm20948I2C | Icm20948Spi](sensor: var T)
  {.importcpp: "#.Process()", header: "dev/icm20948.h".}
  ## Update all sensor readings. Call regularly to fetch fresh data.
proc getAccelVect*[T: Icm20948I2C | Icm20948Spi](sensor: var T): Icm20948Vect
  {.importcpp: "#.GetAccelVect()", header: "dev/icm20948.h".}
  ## Get the latest accelerometer reading in m/s²
proc getGyroVect*[T: Icm20948I2C | Icm20948Spi](sensor: var T): Icm20948Vect
  {.importcpp: "#.GetGyroVect()", header: "dev/icm20948.h".}
  ## Get the latest gyroscope reading in rad/s
proc getMagVect*[T: Icm20948I2C | Icm20948Spi](sensor: var T): Icm20948Vect
  {.importcpp: "#.GetMagVect()", header: "dev/icm20948.h".}
  ## Get the latest magnetometer reading in µT
proc getTemp*[T: Icm20948I2C | Icm20948Spi](sensor: var T): cfloat
  {.importcpp: "#.GetTemp()", header: "dev/icm20948.h".}
  ## Get the latest temperature reading in °C
proc setAccelRange*[T: Icm20948I2C | Icm20948Spi](sensor: var T, range: Icm20948AccelRange)
  {.importcpp: "#.SetAccelRange(@)", header: "dev/icm20948.h".}
  ## Set the accelerometer measurement range (2g, 4g, 8g, or 16g).
proc getAccelRange*[T: Icm20948I2C | Icm20948Spi](sensor: var T): Icm20948AccelRange
  {.importcpp: "#.GetAccelRange()", header: "dev/icm20948.h".}
  ## Get the current accelerometer measurement range
proc setGyroRange*[T: Icm20948I2C | Icm20948Spi](sensor: var T, range: Icm20948GyroRange)
  {.importcpp: "#.SetGyroRange(@)", header: "dev/icm20948.h".}
  ## Set the gyroscope measurement range (250, 500, 1000, or 2000 DPS).
proc getGyroRange*[T: Icm20948I2C | Icm20948Spi](sensor: var T): Icm20948GyroRange
  {.importcpp: "#.GetGyroRange()", header: "dev/icm20948.h".}
  ## Get the current gyroscope measurement range
proc setMagDataRate*[T: Icm20948I2C | Icm20948Spi](sensor: var T, rate: Ak09916DataRate): bool
  {.importcpp: "#.SetMagDataRate(@)", header: "dev/icm20948.h".}
  ## Set the magnetometer data rate (10Hz, 20Hz, 50Hz, or 100Hz).
  ## **Returns:** true on success, false on failure.
proc getMagDataRate*[T: Icm20948I2C | Icm20948Spi](sensor: var T): Ak09916DataRate
  {.importcpp: "#.GetMagDataRate()", header: "dev/icm20948.h".}
  ## Get the current magnetometer data rate
proc setAccelRateDivisor*[T: Icm20948I2C | Icm20948Spi](sensor: var T, divisor: uint16)
  {.importcpp: "#.SetAccelRateDivisor(@)", header: "dev/icm20948.h".}
  ## Set the accelerometer sample rate divisor. Rate = 1125Hz / (1 + divisor).
proc setGyroRateDivisor*[T: Icm20948I2C | Icm20948Spi](sensor: var T, divisor: uint8)
  {.importcpp: "#.SetGyroRateDivisor(@)", header: "dev/icm20948.h".}
  ## Set the gyroscope sample rate divisor. Rate = 1100Hz / (1 + divisor).
